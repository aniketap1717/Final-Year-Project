...
html_temp = """
    ...
    <center><h1>Skin Melanoma Stage Detection Using Machine Learning </h1></center>
...
html_temp = """
    <div>
    <h2></h2>
    <center><h3>Please upload any Skin Image from the given list</h3></center>
    <center><h3> [stage1, stage2] </h3></center>
    </div>
    """

st.set_option("deprecation.showfileUploaderEncoding", False)
st.markdown(html_temp, unsafe_allow_html=True)
st.image("pg.jpg", caption='Skin Melanoma Stage Detection System')
st.image("pg1.jpg", caption='Skin Melanoma Stage Detection System')
